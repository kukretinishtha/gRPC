...
class GreeterStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SayHelloStream = channel.unary_stream(
                ...
                request_serializer=streaming__pb2.HelloRequest.SerializeToString,
                response_deserializer=streaming__pb2.HelloReply.FromString,
...
def add_GreeterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SayHelloStream': grpc.unary_stream_rpc_method_handler(
                    ...
                    request_deserializer=streaming__pb2.HelloRequest.FromString,
                    response_serializer=streaming__pb2.HelloReply.SerializeToString,
            ),
...
class Greeter(object):
    ...
    def SayHelloStream(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            target,
            '/helloworld.Greeter/SayHelloStream',
            streaming__pb2.HelloRequest.SerializeToString,
            streaming__pb2.HelloReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
